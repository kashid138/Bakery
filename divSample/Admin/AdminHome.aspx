<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="divSample.Admin.AdminHome" %>
        ...
        <div class="container-fluid">
            <div class="row jumbotron">
                <div class="col-xs-12 col-sm-12 col-md-9 col-xl-10">
                    <p class="lead">
                        <h2>Hello! Welcome To Bird's!</h2>
                    </p>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2" style="width: 100%">
                    <a href="#">
                        <button type="button" class="btn btn-outline-secondary btn-lg">Hosting</button>
                    </a>
                </div>
            </div>
        </div>
